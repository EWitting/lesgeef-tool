"""De scope-balk: welke seizoenen en welk tijdvenster "Automatisch invullen" (fase 4), het
aanmaken van een beschikbaarheidsronde (fase 6) en het gezondheidspaneel (fase 5) raken.
...
Deze balk is de ENIGE plek om de scope te wijzigen; andere schermen (rondes.py) tonen hem
alleen nog read-only en verwijzen hierheen."""
...
def create_scope_balk(container: ui.row) -> None:
    ...
    with container:
        ui.icon("filter_alt").classes("text-grey-7").tooltip(
            ...
            "en het gezondheidspaneel raken. Lessen buiten de scope krijgen geen "
            "gekleurde rand in de kalender."
        )
